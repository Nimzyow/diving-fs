...
describe("Create user mutation", () => {
    ...
    it("is successful", async () => {
        ...
        expect(createUserResult.data).toEqual({
            createUser: { token: "signed", createUserError: null },
        })
    })
    ...
    it("will return error object with empty string for email, firstName, lastName or password", async () => {
        ...
        expect(createUserResult.data).toEqual({
            createUser: {
                token: null,
                createUserError: { field: "invalidInputs", message: "Please enter valid inputs" },
            },
        })
    })
    ...
    it("will return error object if email already taken", async () => {
        ...
        expect(createUserResult.data).toEqual({
            createUser: {
                token: null,
                createUserError: { field: "emailTaken", message: "This email has already been taken" },
            },
        })
    })
